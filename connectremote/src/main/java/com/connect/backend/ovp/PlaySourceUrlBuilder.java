...
public class PlaySourceUrlBuilder {
    ...
    private boolean assertMandatoryValues() {
        return !TextUtils.isEmpty(baseUrl) && !TextUtils.isEmpty(partnerId) && !TextUtils.isEmpty(entryId) && !TextUtils.isEmpty(extension) && !TextUtils.isEmpty(format);
    }
    ...
    public String build() {
        ...
        boolean hasUiConfId = !TextUtils.isEmpty(uiConfId);
        boolean hasFlavors = !TextUtils.isEmpty(flavorIds);
        if (hasFlavors) {
