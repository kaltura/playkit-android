...
//    public static boolean workAroundRequired;
    ...
    /* package */ com.google.android.exoplayer2.video.CustomVideoCodecRenderer.OnFrameRenderedListenerV23 tunnelingOnFrameRenderedListener;
    ...
    protected void configureCodec(MediaCodecInfo codecInfo, MediaCodec codec, Format format,
        ...
        if (Util.SDK_INT >= 23 && tunneling) {
            tunnelingOnFrameRenderedListener = new com.google.android.exoplayer2.video.CustomVideoCodecRenderer.OnFrameRenderedListenerV23(codec);
        }
    }
    ...
    /**
     * Returns {@link com.google.android.exoplayer2.video.MediaCodecVideoRenderer.CodecMaxValues} suitable for configuring a codec for {@code format} in a way
     * that will allow possible adaptation to other compatible formats in {@code streamFormats}.
     *
     * @param codecInfo Information about the {@link MediaCodec} being configured.
     * @param format The format for which the codec is being configured.
     * @param streamFormats The possible stream formats.
     * @return Suitable {@link com.google.android.exoplayer2.video.MediaCodecVideoRenderer.CodecMaxValues}.
     * @throws DecoderQueryException If an error occurs querying {@code codecInfo}.
     */
    protected com.google.android.exoplayer2.video.MediaCodecVideoRenderer.CodecMaxValues getCodecMaxValues(MediaCodecInfo codecInfo, Format format,
        ...
        if (streamFormats.length == 1) {
            ...
            // being configured.
            return new com.google.android.exoplayer2.video.MediaCodecVideoRenderer.CodecMaxValues(maxWidth, maxHeight, maxInputSize);
        }
    ...
    protected MediaFormat getMediaFormat(Format format, com.google.android.exoplayer2.video.MediaCodecVideoRenderer.CodecMaxValues codecMaxValues,
    ...
    /**
     * Returns whether a codec with suitable {@link com.google.android.exoplayer2.video.MediaCodecVideoRenderer.CodecMaxValues} will support adaptation between
     * two {@link Format}s.
     *
