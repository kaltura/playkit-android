 ...
 */
@TargetApi(16)
public class CustomVideoCodecRendererOld extends MediaCodecRenderer {
     ...
     */
    public CustomVideoCodecRendererOld(Context context, MediaCodecSelector mediaCodecSelector) {
     ...
     */
    public CustomVideoCodecRendererOld(
            Context context,
    ...
    public CustomVideoCodecRendererOld(Context context, MediaCodecSelector mediaCodecSelector,
        ...
        super(
                ...
                /* enableDecoderFallback= */false, /* assumedMinimumCodecOperatingRate= */30); // FIXME:
    ...
    protected int supportsFormat(MediaCodecSelector mediaCodecSelector,
        ...
        if (decoderInfos.isEmpty()) {
            return requiresSecureDecryption
                    && getDecoderInfos(mediaCodecSelector, format, /* requiresSecureDecoder= */ false) // FIXME: CHeck what is tunneling decoder functionality
                    .isEmpty()
    ...
    protected List<MediaCodecInfo> getDecoderInfos(MediaCodecSelector mediaCodecSelector, Format format, boolean requiresSecureDecoder) throws DecoderQueryException {
        // FIXME: WHat is this.
        return mediaCodecSelector.getDecoderInfos(format.sampleMimeType, requiresSecureDecoder,/* requiresTunnelingDecoder= */ true);
    }
