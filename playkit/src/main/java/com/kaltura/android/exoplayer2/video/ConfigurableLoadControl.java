...
public class ConfigurableLoadControl implements LoadControl {
    ...
    /** Builder for {@link ConfigurableLoadControl}. */
    public static final class Builder {
         ...
         */
        @Deprecated
        public ConfigurableLoadControl createDefaultLoadControl() {
            return build();
        }

        /** Creates a {@link ConfigurableLoadControl}. */
        public ConfigurableLoadControl build() {
            checkState(!buildCalled);
            buildCalled = true;
            if (allocator == null) {
    ...
    private static final PKLog log = PKLog.get("ConfigurableLoadControl");
    ...
    public ConfigurableLoadControl() {
        this(
    ...
    public void setMinBufferUs(long minBufferUs) {
        this.minBufferUs = minBufferUs;
    }

    public void setMaxBufferUs(long maxBufferUs) {
        this.maxBufferUs = maxBufferUs;
    }

    public void setBufferForPlaybackUs(long bufferForPlaybackUs) {
        this.bufferForPlaybackUs = bufferForPlaybackUs;
    }

    public void setBufferForPlaybackAfterRebufferUs(long bufferForPlaybackAfterRebufferUs) {
        this.bufferForPlaybackAfterRebufferUs = bufferForPlaybackAfterRebufferUs;
    }

    public void setTargetBufferBytesOverwrite(int targetBufferBytesOverwrite) {
        this.targetBufferBytesOverwrite = targetBufferBytesOverwrite;
    }

    public void setPrioritizeTimeOverSizeThresholds(boolean prioritizeTimeOverSizeThresholds) {
        this.prioritizeTimeOverSizeThresholds = prioritizeTimeOverSizeThresholds;
    }

    public void setBackBufferDurationUs(long backBufferDurationUs) {
        this.backBufferDurationUs = backBufferDurationUs;
    }

    public void setRetainBackBufferFromKeyframe(boolean retainBackBufferFromKeyframe) {
        this.retainBackBufferFromKeyframe = retainBackBufferFromKeyframe;
    }
