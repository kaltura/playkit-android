...
/**
 * An approximate representation of a CustomSegmentBase manifest element.
 */
public abstract class CustomSegmentBase {
    ...
    /**
     * A {@link CustomSegmentBase} that defines a single segment.
     */
    public static class SingleSegmentBase extends CustomSegmentBase {
    ...
    /**
     * A {@link CustomSegmentBase} that consists of multiple segments.
     */
    public abstract static class MultiSegmentBase extends CustomSegmentBase {
         ...
         */
        public abstract RangedUri getSegmentUrl(CustomRepresentation representation, long index);
    ...
    public static final class SegmentList extends CustomSegmentBase.MultiSegmentBase {
        ...
        @Override
        public RangedUri getSegmentUrl(CustomRepresentation representation, long sequenceNumber) {
