...
import com.kaltura.android.exoplayer2.audio.DefaultAudioSink.DefaultAudioProcessorChain;
...
public class CustomRenderersFactory implements RenderersFactory {
    ...
    @CustomRenderersFactory.ExtensionRendererMode
    ...
    /**
     * @deprecated Use {@link #CustomRenderersFactory(Context)} and {@link
     *     #setExtensionRendererMode(int)}.
     */
    @Deprecated
    @SuppressWarnings("deprecation")
    public CustomRenderersFactory(
            Context context, int extensionRendererMode) {
        this(context, extensionRendererMode, DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
    }

    /**
     * @deprecated Use {@link #CustomRenderersFactory(Context)}, {@link
     ...
     */
    public CustomRenderersFactory setExtensionRendererMode(
            @CustomRenderersFactory.ExtensionRendererMode int extensionRendererMode) {
        this.extensionRendererMode = extensionRendererMode;
        return this;
    }
     ...
     * CustomMediaCodecVideoRenderer} instances.
     *
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory experimentalSetAsynchronousBufferQueueingEnabled(boolean enabled) {
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory experimentalSetForceAsyncQueueingSynchronizationWorkaround(
            boolean enabled) {
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory experimentalSetSynchronizeCodecInteractionsWithQueueingEnabled(
            boolean enabled) {
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory setEnableDecoderFallback(boolean enableDecoderFallback) {
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory setMediaCodecSelector(MediaCodecSelector mediaCodecSelector) {
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory setEnableAudioFloatOutput(boolean enableFloatOutput) {
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory setEnableAudioOffload(boolean enableOffload) {
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory setEnableAudioTrackPlaybackParams(
     ...
     * @return This factory, for convenience.
     */
    public CustomRenderersFactory setAllowedVideoJoiningTimeMs(long allowedVideoJoiningTimeMs) {
        this.allowedVideoJoiningTimeMs = allowedVideoJoiningTimeMs;
        return this;
    }
    ...
    protected void buildVideoRenderers(
        ...
        try {
            // Full class names used for constructor args so the LINT rule triggers if any of them move.
            Class<?> clazz = Class.forName("com.kaltura.android.exoplayer2.ext.av1.Libgav1VideoRenderer");
            Constructor<?> constructor =
                    clazz.getConstructor(
                            long.class,
                            android.os.Handler.class,
        ...
        try {
            ...
            Constructor<?> constructor =
                    clazz.getConstructor(
                            ...
                            com.kaltura.android.exoplayer2.audio.AudioSink.class);
            Renderer renderer =
    ...
    protected void buildCameraMotionRenderers(
            Context context, int extensionRendererMode, ArrayList<Renderer> out) {
