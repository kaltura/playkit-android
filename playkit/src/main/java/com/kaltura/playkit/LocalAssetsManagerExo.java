...
public class LocalAssetsManagerExo {
    ...
    public void registerWidevineAsset(String assetId, String licenseUri, byte[] drmInitData, boolean forceWidevineL3Playback) throws LocalAssetsManager.RegisterException {
