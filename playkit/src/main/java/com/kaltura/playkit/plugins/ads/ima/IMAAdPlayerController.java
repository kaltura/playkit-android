package com.kaltura.playkit.plugins.ads.ima;// Copyright 2014 Google Inc. All Rights Reserved.
 ...
 */
public class IMAAdPlayerController {
    ...
    private IMAPlugin mVideoPlayerWithAdPlayback;
    ...
    public IMAAdPlayerController(Context context,
                                 IMAPlugin videoPlayerWithAdPlayback, View playButton,
        ...
        mAdsLoader.addAdsLoadedListener(new IMAAdPlayerController.AdsLoadedListener());

        mVideoPlayerWithAdPlayback.setOnContentCompleteListener(
                new IMAPlugin.OnContentCompleteListener() {
                    /**
