...
//        mVideoPlayer.play();
//        mIsAdDisplayed = false;
//        mVideoPlayer.getPlayer().setPlaybackPrepare(this);
//        //mVideoPlayer.getPlayer().setPlayWhenReady(true);//.prepare(buildMediaSource(Uri.parse(mContentVideoUrl), "mp4"));
//        restorePosition();
//        play();
    }
...
//        mIsAdDisplayed = false;
//        player.prepare(mContentVideoUrl);
